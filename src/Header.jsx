  ...
  return (
    ...
    className='w-full  flex flex-col lg:flex-row mt-1 md:mt-25'>
        <div className='w-full  py-4 flex flex-col px-4 md:px-22 text-left mt-10 md:mt-30'>
            <h1 className='text-5xl font-extrabold  text-black text-left'>Hello, I'm Taimur Imam.</h1>
            <p className=' text-black text-left text-xl font-light mt-2'>Full Stack Developer | iOS |
                 Android | Web Dev. </p>  
            <p className=' text-black text-left text-xl font-light mt-8'>
                I am a Top Rated Plus developer with a 100% job success rate.</p>     
            <button className='bg-black text-white px-6 py-3 rounded-sm w-40 mt-2 hover:bg-red-800'>Upwork</button>
        <SocialIcons/> 
        </div> 
        <div className='w-full  py-4 flex  px-4 md:px-22  '>
            <img className='hidden md:block w-full h-96 object-cover mt-16' src={sapLogo} alt="header" />
        </div>
    </motion.div>
  )
}
