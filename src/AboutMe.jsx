  ...
  return (
    ...
    >    
        <div className='w-full  py-4 flex  px-4 md:px-22  '>
            <img className='w-120 h-120 object-cover mt-8 rounded-full border-8  border-white shadow-[0_4px_6px_-1px_rgba(0,0,0,0.2),0_2px_4px_-1px_rgba(0,0,0,0.02)] ' src={profile} alt="header" />
        </div>
        <div className='w-full  py-4 flex  flex-col  px-1  text-left  '>
            <h1 className='text-5xl font-extrabold  text-black text-left'>About Me</h1>
            <p className=' text-black text-left text-l font-extralight mt-2 text-lg'>I have over 10 years of experience working with clients of all sizes. Social Networks, Games, Education, Retail, I have done it all! I especially love working on challenging, never-done-before projects!</p>  
            <p className=' text-black text-left text-l font-extralight mt-4 text-lg'>
